    ...
    <section className="relative py-24 lg:py-40 px-6 hero-gradient overflow-hidden" id="home">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative flex justify-center lg:justify-start order-2 lg:order-1 animate-fade-up">
          <div className="relative w-72 h-72 lg:w-112.5 lg:h-112.5">
        ...
        <div className="flex flex-col gap-10 order-1 lg:order-2 animate-fade-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <a href="https://github.com/nilanjanajui" target="_blank" rel="noreferrer"
              className="bg-white/5 hover:bg-white/10 text-light-bg border border-white/10 px-10 py-5 rounded-xl font-bold transition-all flex items-center gap-2 transform hover:-translate-y-1">
