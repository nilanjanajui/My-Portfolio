      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-secondary border border-white/5 rounded-2xl lg:rounded-4xl overflow-hidden flex flex-col lg:flex-row shadow-2xl">
          ...
          >
            ...
            />
            {/* Hover hint overlay */}
            <div className="absolute inset-3 sm:inset-4 lg:inset-8 rounded-xl flex items-center justify-center bg-black/40 group-hover/video:opacity-0 transition-opacity duration-300 pointer-events-none">
            </div>
          </div>
          ...
          <div className="w-full lg:w-2/5 p-6 sm:p-8 lg:p-12 flex flex-col justify-center">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-light-bg mb-4 sm:mb-6">Database Design Studio</h2>
            <p className="text-text-dim text-base sm:text-lg mb-6 sm:mb-8 leading-relaxed">
              A full-stack application that automates database normalization (1NF → 3NF),
              functional dependency detection, ER diagram generation, and workflow
              visualization — built with Flask and React.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://github.com/nilanjanajui/database-design-studio"
                target="_blank"
                rel="noreferrer"
